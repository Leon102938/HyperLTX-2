...
# 3. Finale LoRA Downloads (Exakt nach deiner Vorgabe)
echo "📥 Lade LoRAs in $LORA_DIR..."

# Cakeify von kabachuha
...
# Detailer von Lightricks (eigenes Repo)
...
# Static Camera von Lightricks (eigenes Repo)
